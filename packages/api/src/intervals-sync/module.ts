    ...
    syncNow(userId) {
      return Effect.gen(function* () {
        ...
        const syncEffect = Effect.gen(function* () {
          ...
          const latestCursor =
            yield* options.ledger.latestSuccessfulCursor(userId);
          ...
          return yield* options.ledger.completeSuccess({
            eventId,
